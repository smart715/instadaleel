                                                                                     ...
                                                                                     <td width="560" class="esd-container-frame" align="center" valign="top">
                                                                                          <table cellpadding="0" cellspacing="0" width="100%">
                                                                                               <tbody>
                                                                                                    ...
                                                                                                    <tr>
                                                                                                         <td style="padding: 15px;">
                                                                                                              <p style="text-align: center;;">Your offer status updated by admin</p>
                                                                                                         </td>
                                                                                                    </tr>
                                                                                               </tbody>
                                                                                          </table>
                                                                                          ...
                                                                                          <table cellpadding="0" cellspacing="0" width="100%">
                                                                                               <tbody>
                                                                                                    <tr style="border: 1px solid black;">
                                                                                                         <td style="padding: 15px; text-align: center; border: 1px solid black">Offer Title</td>
                                                                                                    ...
                                                                                                    <tr style="border: 1px solid black;">
                                                                                                         ...
                                                                                                         <td style="padding: 15px; text-align: center; border: 1px solid black">
                                                                                                              {{ $offer->is_approved ? 'Approved' : 'Not Approved' }}
                                                                                                         </td>
                                                                                                    </tr>
                                                                                               </tbody>
                                                                                          </table>
