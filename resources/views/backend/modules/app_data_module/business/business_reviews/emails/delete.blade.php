                                                                                     ...
                                                                                     <td width="560" class="esd-container-frame" align="center" valign="top">
                                                                                          <table cellpadding="0" cellspacing="0" width="100%">
                                                                                               <tbody>
                                                                                                    ...
                                                                                                    <tr>
                                                                                                         <td style="padding: 15px;">
                                                                                                              <p style="text-align: center;;">Your business review deleted by admin</p>
                                                                                                         </td>
                                                                                                    </tr>
                                                                                               </tbody>
                                                                                          </table>
                                                                                          ...
                                                                                          <table cellpadding="0" cellspacing="0" width="100%">
                                                                                               <tbody>
                                                                                                    <tr style="border: 1px solid black;">
                                                                                                         <td style="padding: 15px; text-align: center; border: 1px solid black">Star</td>
                                                                                                         <td style="padding: 15px; text-align: center; border: 1px solid black">
                                                                                                              {{ $business_review->rating }}
                                                                                                         </td>
                                                                                                    </tr>
                                                                                                    <tr style="border: 1px solid black;">
                                                                                                         <td style="padding: 15px; text-align: center; border: 1px solid black">Comment</td>
                                                                                                         <td style="padding: 15px; text-align: center; border: 1px solid black">
                                                                                                              {{ $business_review->comment }}
                                                                                                         </td>
                                                                                                    </tr>
                                                                                               </tbody>
                                                                                          </table>
